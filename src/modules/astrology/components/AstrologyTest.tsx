  ...
  return (
    <div className={cn('max-w-2xl mx-auto p-4 safe-area-container', className)}>
        ...
        <div className="relative">
          <CardHeader className="text-center mobile-content">
            <div className="space-y-4">
              <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full flex items-center justify-center text-2xl sm:text-3xl">
                ✨
              </div>
              <div>
          ...
          <CardContent className="mobile-content">
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4 border border-purple-200">
                <h3 className="font-semibold text-purple-800 mb-2 mobile-text-sm">关于星座分析</h3>
                <p className="mobile-text-sm text-purple-700 leading-relaxed">
              ...
              <div className="text-center">
                <Button
                  ...
                  className="px-8 py-3 mobile-text-base mobile-button relative"
                >
                  {isCalculating ? (
              ...
              <div className="text-center space-y-2">
                ...
                <div className="flex justify-center space-x-2 sm:space-x-4 mobile-text-sm text-gray-400">
                  <span>🌟 性格特质</span>
                  <span>💫 运势分析</span>
                  <span>💝 兼容性测试</span>
                  <span>🍀 幸运元素</span>
      ...
      <div className="mt-6 text-center">
        <div className="flex justify-center flex-wrap gap-2 sm:gap-4 text-xl sm:text-2xl opacity-60">
          <span>♈</span>
          <span>♉</span>
          <span>♊</span>
          <span>♋</span>
        ...
        <p className="mobile-text-sm text-gray-500 mt-2">十二星座守护着不同的人生智慧</p>
      </div>
    </div>
  );
};
